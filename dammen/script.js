...
function declareWinner() {
    ...
    var winnerText = the_checker[1].color == "white" ? "Black" : "Red";
    score.innerHTML = winnerText + " Wins!";

    var replayButton = document.createElement("button");
    replayButton.textContent = "Click to Replay";
    ...
    score.appendChild(replayButton);
}
